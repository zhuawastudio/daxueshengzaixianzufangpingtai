    ...
    */
    ...
    public R shenhe(@RequestBody FangwuYuyueEntity fangwuYuyueEntity, HttpServletRequest request){
        ...
        if(fangwuYuyueEntity.getFangwuYuyueYesnoTypes() == 2){//通过
            ...
            YonghuEntity yonghuEntity = yonghuService.selectById(oldFangwuYuyue.getYonghuId());
            Double fangwuNewMoney = fangwuEntity.getFangwuNewMoney();
            Double newMoney = yonghuEntity.getNewMoney();
            if (newMoney<fangwuNewMoney)
                return R.error("用户余额不足");
            yonghuEntity.setNewMoney(newMoney-fangwuNewMoney);
            fangwuEntity.setFangwuZhuangtaiTypes(1);
            fangwuService.updateById(fangwuEntity);
            yonghuService.updateById(yonghuEntity);
//            fangwuYuyueEntity.setFangwuYuyueTypes();
...
//                            fangwuYuyueEntity.setFangwuId(Integer.valueOf(data.get(0)));   //房屋 要改的
//                            fangwuYuyueEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            fangwuYuyueEntity.setFangwuYuyueText(data.get(0));                    //报名理由 要改的
//                            fangwuYuyueEntity.setFangwuYuyueFile(data.get(0));                    //学生证 要改的
//                            fangwuYuyueEntity.setInsertTime(date);//时间
//                            fangwuYuyueEntity.setFangwuYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //报名状态 要改的
...
//                            fangwuYuyueEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody FangwuYuyueEntity fangwuYuyue, HttpServletRequest request){
        ...
        Wrapper<FangwuYuyueEntity> queryWrapper = new EntityWrapper<FangwuYuyueEntity>()
            .eq("fangwu_yuyue_uuid_number", fangwuYuyue.getFangwuYuyueUuidNumber())
            .eq("fangwu_id", fangwuYuyue.getFangwuId())
            .eq("yonghu_id", fangwuYuyue.getYonghuId())
            .eq("fangwu_yuyue_text", fangwuYuyue.getFangwuYuyueText())
            .in("fangwu_yuyue_yesno_types", new Integer[]{1,2})
            .eq("fangwu_yuyue_yesno_text", fangwuYuyue.getFangwuYuyueYesnoText())
//            .notIn("fangwu_yuyue_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        FangwuYuyueEntity fangwuYuyueEntity = fangwuYuyueService.selectOne(queryWrapper);
        if(fangwuYuyueEntity==null){
