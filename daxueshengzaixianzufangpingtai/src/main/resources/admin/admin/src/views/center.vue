<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='fangdong'"  label='房东编号' prop="fangdongUuidNumber">
               <el-input v-model="ruleForm.fangdongUuidNumber"disabled="true"   placeholder='房东编号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
...
// 注册表 房东 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.fangdongUuidNumber)&& 'fangdong'==this.flag){
