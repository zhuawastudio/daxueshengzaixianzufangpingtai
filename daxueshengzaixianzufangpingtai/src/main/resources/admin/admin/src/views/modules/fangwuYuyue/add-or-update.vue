    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='fangwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋地点" prop="fangwuAddress">
                        <el-input v-model="fangwuForm.fangwuAddress"
                                  placeholder="房屋地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='fangwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋状态" prop="fangwuZhuangtaiValue">
                        <el-input v-model="fangwuForm.fangwuZhuangtaiValue"
                                  placeholder="房屋状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="fangwuYuyueText">
                        <el-input type="textarea"  :readonly="ro.fangwuYuyueText" v-model="ruleForm.fangwuYuyueText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuYuyueText" label="报名理由" prop="fangwuYuyueText">
                            <span v-html="ruleForm.fangwuYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.fangwuYuyueFile" label="学生证" prop="fangwuYuyueFile">
                        <file-upload
                                tip="点击上传学生证"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.fangwuYuyueFile?$base.url+ruleForm.fangwuYuyueFile:''"
                                @change="fangwuYuyueFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangwuYuyueFile" label="学生证" prop="fangwuYuyueFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.fangwuYuyueFile"  >学生证下载</a>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuYuyueYesnoTypes" label="报名状态" prop="fangwuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.fangwuYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '房屋租赁时间不能为空', trigger: 'blur' },
                          ],
                   fangwuYuyueYesnoTypes: [
        ...
        methods: {
            ...
            //图片
            fangwuYuyueFileUploadChange(fileUrls){
                this.ruleForm.fangwuYuyueFile = fileUrls;
                this.addEditUploadStyleChange()
            },
