    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生在线租房平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="房东编号" class="input" v-if="tableName=='fangdong'">
                                <el-input v-model="ruleForm.fangdongUuidNumber" autocomplete="off" placeholder="房东编号"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // fangdong 中的 房东编号 判空处理
                            // if('fangdong' == this.tableName && (this.ruleForm.fangdongUuidNumber== null ||this.ruleForm.fangdongUuidNumber== "")){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/daxueshengzaixianzufangpingtai/img/back-img-bg.jpg);
