    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.baoxiuYesnoTypes" label="申请状态" prop="baoxiuYesnoTypes">
                        <el-input v-model="ruleForm.baoxiuYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.baoxiuYesnoText" label="审核意见" prop="baoxiuYesnoText">
                        <span v-html="ruleForm.baoxiuYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.baoxiuShenheTime" label="审核时间" prop="baoxiuShenheTime">
                        <span v-html="ruleForm.baoxiuShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    baoxiuTypes: false,
                    baoxiuContent: false,
                    baoxiuYesnoTypes: false,
                    baoxiuYesnoText: false,
                    baoxiuShenheTime: false,
                    insertTime: false,
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoxiu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.baoxiuYesnoTypesOptions = data.data.list;
                    }
                });
                this.$http({
